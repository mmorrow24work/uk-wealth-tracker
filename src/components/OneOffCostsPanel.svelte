<script>
	 ...
	 * editable list of named rows (what for, starts in how many years, how much) rather than a
	 * fixed set of dials.
	 *
	 ...
	 * every sibling scenario panel: there is no slot for a planning scenario on `AppData` yet.
	 */
