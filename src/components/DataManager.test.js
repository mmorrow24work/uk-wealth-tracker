 ...
 * (`switchMode`, `exportData`, `onFileChosen`/`confirmImport`) are covered at module level by
 * `$lib/data-transfer.test.js`, `$lib/persistence.test.js` and `$lib/store.test.js`, which this
