<script>
	...
	// These local arrays are not persisted — that lands with the store (#5) and the Gist wiring it
	// syncs to; for now debts (and the activity log of changes to them) entered here live only for
