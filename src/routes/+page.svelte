<script>
	...
	// This local array is not persisted — that lands with the store (#5) and the Gist wiring it
	// syncs to; for now debts entered here live only for the current page session.
